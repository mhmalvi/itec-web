...
@section('title', "Certificate IV in Commercial Cookery")
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-9">
                        <h2 class="section-title text-light">SIT40516</h2>
                        <h2 class="section-title text-light">Certificate IV in Commercial Cookery</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
            ...
            <div class="row">
                <div class="col-12" data-aos="fade-up">
                    <figure class="post-image text-center">
                        <img src="{{ asset('course_images/SIT40516.webp') }}"
                            alt="Image">
                    </figure>
                </div>
                <!-- end col-12 -->
