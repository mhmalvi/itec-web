...
@section('title', "Certificate IV in Ageing Support")
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-9">
                        <h2 class="section-title text-light">CHC43015</h2>
                        <h2 class="section-title text-light">Certificate IV in Ageing Support</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
            ...
            <div class="row">
                <div class="col-12" data-aos="fade-up">
                    <figure class="post-image text-center">
                        <img src="{{ asset('course_images/CHC43015.webp') }}"
                            alt="Image">
                    </figure>
                </div>
                <!-- end col-12 -->
