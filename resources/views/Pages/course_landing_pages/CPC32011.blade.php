...
@section('title', "Certificate III in Carpentry and Joinery")
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-9">
                        <h2 class="section-title text-light">CPC32011</h2>
                        <h2 class="section-title text-light">Certificate III in Carpentry and Joinery</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
            ...
            <div class="row">
                <div class="col-12" data-aos="fade-up">
                    <figure class="post-image text-center">
                        <img src="{{ asset('course_images/CPC32011.webp') }}"
                            alt="Image">
                    </figure>
                </div>
                <!-- end col-12 -->
