...
@section('title', "Certificate III in Painting and Decorating")
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-lg-9">
                        <p class="text-light">RTO - ATR (45282)</p>
                        <h2 class="section-title text-light">CPC30611</h2>
                        <h2 class="section-title text-light">Certificate III in Painting and Decorating</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                    ...
                    <table class="table table-bordered text-white">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <li>Language and concepts appropriate to cultural differences</li></ul><ul class="ait13"><li>Follows instructions from supervisor and other relevant persons</li></ul><ul class="ait14"><li>Understands, interprets and applies information as required from:</li>
                                <li>Regulatory, legislative, licensing and organisational requirements</li>
                                ...
                                <li>Prepares quotations, tender documentation and other costing documents as required</li>
                                <li>Records relevant information, including details of products, services, costs and inspection logs</li>
                                <li>Calculates materials, labour and overhead costs, including mark-up percentages</li>
                            ...
                            <tr>
                                ...
                                <li>Checks job location and storage/holding area to ensure adequate provision of ventilation and fire safety</li>
                                <li>Carries out tests on substrate and surface materials</li>
                                <li>Matches paint colour to specified sample</li>
                                <li>Rectifies simple faults with tools and equipment</li></ul><p class="
                                        "></p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <li>Carries out site inspection to confirm requirements</li>
                                <li>Estimates materials, labour and time for job</li>
                                <li>Determines material quantity requirements and checks for conformity to requirements</li>
                            ...
                            <tr>
                                ...
                                <li>Carries out pre- and post-operational checks on tools and equipment</li>
                                <li>Performs tool and equipment maintenance as required</li></ul></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered text-white">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="" width="693">
                                <p class="
                                        ">Calculate and cost construction work</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" width="303">
                            ...
                            <tr>
                                ...
                                <p class="
                                        "><strong class="
                                        ait24">Painting and decorating preparation field of work </strong>&nbsp;</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Erect and maintain trestle and plank systems</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Handle painting and decorating materials</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Use painting and decorating tools and equipment</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Remove and replace doors and door and window components</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Prepare surfaces for painting</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px solid #333333;border-right: 0px solid #333333;border-top: 1px solid #333333;border-bottom: 0px solid #333333;;vertical-align: top;" colspan="2" width="943">
                            ...
                            <tr>
                                ...
                                <p class="
                                        "><strong class="
                                        ait24">Painting and decorating operations field of work </strong>&nbsp;</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px solid #333333;border-right: 0px solid #333333;border-top: 0px solid #333333;border-bottom: 1px solid #333333;;vertical-align: top;" colspan="2" width="943">
                            ...
                            <tr>
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply paint by brush and roller</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply texture coat paint finishes by brush, roller and spray</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                            ...
                            <tr>
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Match specified paint colour</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply stains and clear timber finishes</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                            ...
                            <tr>
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply decorative paint finishes</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Implement safe lead paint and asbestos work practices in the painting industry</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px solid #333333;border-right: 0px solid #333333;border-top: 1px solid #333333;border-bottom: 0px solid #333333;;vertical-align: top;" colspan="2" width="943">
                            ...
                            <tr>
                                ...
                                <p class="
                                        "><strong class="
                                        ait24">Specialist painting and decorating field of work </strong>&nbsp;</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px solid #333333;border-right: 0px solid #333333;border-top: 0px solid #333333;border-bottom: 1px solid #333333;;vertical-align: top;" colspan="2" width="943">
                            ...
                            <tr>
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Remove graffiti and apply protective coatings</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply protective paint coating systems</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply advanced wallpaper techniques</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                            ...
                            <tr>
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply advanced decorative paint finishes</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="" valign="middle" width="303">
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Apply trowelled texture coat finishes</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="border-left: 0px solid #333333;border-right: 0px solid #333333;border-top: 1px solid #333333;border-bottom: 0px solid #333333;;vertical-align: top;" colspan="2" width="943">
                            ...
                            <tr>
                                ...
                                <td style="" valign="middle" width="693">
                                <p class="
                                        ">Glaze/re-glaze residential windows and doors</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="row">
                <div class="col-12" data-aos="fade-up">
                    <figure class="post-image text-center">
                        <img src="{{ asset('course_images/CPC30611.webp') }}"
                            alt="Image">
                    </figure>
                </div>
                <!-- end col-12 -->
