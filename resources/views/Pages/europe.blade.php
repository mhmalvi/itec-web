...
@section('title', 'Study in Europe')

@section('content')
    <!-- end all-cases-link -->
    <header class="page-header">
        <div class="video-bg img-bg img-bg-3">
        <!-- end video-bg -->
        <div class="inner">
            <div class="container">
            ...
            <div class="row my-5">
                <div class="col-lg-12" data-aos="fade-up">
                    <p class="text-center">
                        ...
                        support students with their questions about education in Europe. You can choose any of the following
                        country to study:
                    </p>
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Austria has a long history of higher education and cutting-edge science
                                    that has earned it a global reputation. Furthermore, Austrians are very hospitable and
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Belgium has long been regarded as the heart of Western Europe, serving
                                    as the official headquarters of the European Union. This small country's history is rich
                                    in beauty and culture, manifesting itself in some of Europe's most elegant, fairy-tale
                                    settings.</p>
                            </div>
                        </div>
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Bulgaria is a crossroads between East and West. It is the birthplace of
                                    the first written Slavic language, which is now spoken in Bulgaria, Ukraine, Macedonia,
                                    Serbia, Turkey, Greece, and Romania, among other places. Learn more about Bulgarian
                                    studies in the sections below.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-group">
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Croatia extends from the Alps' eastern edges in the north to the
                                    Pannonian lowlands and Danube's banks in the east. Come here to learn about and
                                    appreciate a rich historical and cultural heritage while also taking in the stunning
                                    scenery!</p>
                            </div>
                        </div>
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Cyprus is a good place to study because it has over 300 days of
                                    sunshine per year and a summer that lasts from May to October. You can receive a
                                    high-quality international education at a low cost if you study in Cyprus. Do you want
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">If you're aiming for a unique European study abroad journey, the Czech
                                    Republic is the place to go. Prague, Liberec, Brno, and Olomouc are all famous study
                                    abroad cities in the Czech Republic.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-group">
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Denmark combines old-world Nordic elegance with an avowedly
                                    forward-thinking culture – the country consistently ranks among the world's most
                                    livable, safest, and happiest countries. Getting an education in Denmark puts you right
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Few countries could match Estonia's technological advances as one of
                                    the first truly digitalized societies in the world. Estonian students are given a
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Are you looking for a Nordic experience? Finland is home to some of
                                    Europe's best universities, and it was called the happiest country in the world again in
                                    2019!</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Education in France allows students to immerse themselves in the
                                    country's sophisticated culture, discover its vibrant towns, and travel through its
                                    beautiful countryside. Why not study in France and experience the sumptuous
                                    architecture, delectable cuisine, and world-class arts and culture scene for yourself?
                                </p>
                            </div>
                        </div>
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Germany is a highly developed nation with an outstanding standard of
                                    living and a social market economy. It is a global forerunner in manufacturing and
                                    technology. Germany is the ideal place to visit if you want to see a part of Europe that
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">a small country rich in history and culture and home to Georgian, one
                                    of the world's most fascinating languages, is located in the Caucasus, where Europe
                                    meets the Middle East. While learning, explore Georgia.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-group">
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Spending time in Greece will allow you to not only see the beautiful
                                    Mediterranean islands, but also to walk through the ancient streets of Athens. You will
                                    encounter a very friendly community in which time and stress are not as important as
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Hungary is becoming a more popular study abroad destination,
                                    particularly for medical students. Hungary has a vibrant and friendly community, a
                                    fascinating past, and beautiful cities in addition to high-quality education. When
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">The egalitarian nature of Icelandic education is well-known. Many
                                    seeking an education in Iceland will find that the whole system openly promotes equal
                                    opportunities for everyone, regardless of context.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-group">
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">dubbed the Emerald Isle for its vibrant nightlife, is known for its
                                    history, culture, and vibrant nightlife, especially in Dublin and Cork. The rugged
                                    coastline, rolling hills and valleys, and low cost of living in Ireland make it a
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Italy is a diverse country in terms of its natural beauty, culture, and
                                    history. Italy's education system is highly regarded, with a wide variety of excellent
                                    academic institutions located across the country and welcoming foreign students. Immerse
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Latvia shares borders with other Baltic countries such as Estonia and
                                    Lithuania, as well as Belarus, Russia, and Sweden. It has been influenced by the diverse
                                    cultures of its neighboring countries as a result of its unique location, providing
                                    students with a multi-cultural experience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-group">
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Lithuania (or Litvak) is one of the three Baltic States in Northern
                                    Europe. Lithuania has lower tuition rates and a lower cost of living than many other
                                    countries in the country, making it an ideal location for students looking to save money
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Luxembourg has a population of over half a million people, and despite
                                    its small size, it is known as a European melting pot that will provide all students
                                    with an unforgettable learning experience. Learn more about Luxembourg in the sections
                                    below.</p>
                            </div>
                        </div>
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Do you want to learn about Scandinavian culture, see beautiful scenery,
                                    and visit environmentally friendly cities with friendly people? Consider studying in
                                    Norway, one of the richest and, arguably, most beautiful countries in Scandinavia.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-group">
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Do you like diverse nature, cities steeped in history, and delicious
                                    comfort food after a long exam season? If you answered yes to these three questions, and
                                    are looking to study somewhere in Europe - there is a perfect solution for you: Study in
                                    Poland!</p>
                            </div>
                        </div>
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Portugal, a small Mediterranean country, is a diverse and exciting
                                    place to study abroad. There are over 125 private and public higher education
                                    institutions in Portugal. International students studying in Portugal should look
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Romania is a diverse country with something for all, from stunning
                                    monasteries to scenic landscapes with beautiful mountains and medieval cities. Romania
                                    has some of the most affordable tuition and living costs in the EU, making it an
                                    affordable study abroad destination.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card-group">
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Russian culture today is a dynamic blend of tradition and creativity,
                                    thanks to its long and varied history. When foreign students think of Russia, they also
                                    think of the Red Square and St. Basil's Cathedral in Moscow, as well as the Winter
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Natural landscapes, mountains, caves, medieval castles and cities, folk
                                    architecture, spas, and ski resorts can all be found in Slovakia, also known as the
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Spain is a popular study abroad destination for students from all over
                                    the world because of its beautiful beaches, laid-back lifestyle, and delicious food.
                                    Spain came in first place in educations.com's Top 10 Study Abroad Countries in Europe
                                    ranking last year! Learn why 60,000 foreign students come to Spain each year to study!
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">Sweden's education system is no exception to the country's openness to
                                    the international community. In Sweden, international students from all over the world
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">Switzerland is a small nation with a long tradition of excellence in
                                    higher education dating back to 1460. With such a diverse range of higher education
                                    institutions, studying in Switzerland will allow you to explore and learn directly
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">The Netherlands is a country in Europe that borders Germany and France.
                                    The nation is renowned for its cutting-edge educational practices. The Netherlands has
                                    it all, whether you're looking for a bachelor's degree, a diploma program, a master's
                                    degree, or a PhD.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body ">
                                ...
                                <p class="card-text">As an international student in Turkey, you will be able to combine
                                    modernity with tradition in one of the region's safest and most prosperous nations. You
                                    will be more than prepared for a future anywhere in the world thanks to the high
                        ...
                        <div class="card bg-transparent" data-aos="fade-up">
                            <div class="card-body">
                                ...
                                <p class="card-text">The United Kingdom (UK) attracts a diverse number of foreign students
                                    from all over the world every semester, with over 150 higher education institutions,
                                    including some of the world's most prestigious and top-ranked universities. Learn more
                                    about the degrees available in the United Kingdom!</p>
                            </div>
                        </div>
            ...
            <ul>
                <li>
                    <figure data-aos="zoom-in">
                        <img class="lazyload" data-src="{{ asset('images/europe/1.webp') }}" alt="Image">
                    </figure>
                </li>
                <li>
                    <figure data-aos="zoom-in">
                        <img class="lazyload" data-src="{{ asset('images/europe/2.webp') }}" alt="Image">
                    </figure>
                </li>
                <li>
                    <figure data-aos="zoom-in">
                        <img class="lazyload" data-src="{{ asset('images/europe/3.webp') }}" alt="Image">
                    </figure>
                </li>
                <li>
                    <figure data-aos="zoom-in">
                        <img class="lazyload" data-src="{{ asset('images/europe/4.webp') }}" alt="Image">
                    </figure>
                </li>
            </ul>
        </div>
            ...
            <div class="apply" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6 px-0 d-none d-sm-block">
                        <div>
                            <img class="lazyload" data-src="{{asset('assets/images/apply.webp')}}" alt="">
                        </div>
                    </div>
