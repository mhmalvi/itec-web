                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-12 form-group">
                            ...
                            <input type="password" name="old" id="password" class="form-control"/>
                        </div>
                        <div class="col-12 form-group">
                            <label for="newpassword" >New Password</label>
                            <input type="password" name="new" id="newpassword" class="form-control"/>
                        </div>
                        <div class="col-12 form-group">
                            <label for="conpassword">Confirm Password</label>
                            <input type="password" name="confirm" id="conpassword" class="form-control"/>
                        </div>
                    </div>
                </div>
            </div>
